                  ...
                  <div class="col-xl-6">
                    ...
                    <div class="contact_form_container">
                      <form id="contact_form" action="#" class="contact_form clearfix" enctype="multipart/form-data">
                        ...
                        <p>
                          <span v-if="uploadspinner" class="uploadloader" />
                        </p>
...
export default {
  ...
  methods: {
    ...
    async submitPortofolio (e) {
      ...
      await this.$axios({
        url: 'http://64.227.43.157:4000/api/v1/portofolio/',
        method: 'post',
        data: {
          title: this.title,
    ...
    uploadFiles () {
      ...
      this.$axios.post('http://64.227.43.157:4000/api/v1/portofolio/files',
        formData,
        {
          headers: {
            'authorization': getTokken,
